...
<motion.path initial={{pathLength: 0}} animate={{pathLength: rating}} transition={{duration: 1, delay: stars / 6}} d="M1 21L1.00001 5L1 1" stroke="url(#paint0_radial_103_2)" stroke-width="2" stroke-linecap="square"/>
<defs>
